...
class TestShutdownBehavior:
    ...
    def test_responsive_timeout_logic(self):
        ...
        for scan_timeout, expected in test_cases:
            ...
            assert responsive_timeout == expected, f"Failed for {scan_timeout}: got {responsive_timeout}, expected {expected}"
    ...
    def test_global_shutdown_manager_instance(self):
        ...
        from src.plugins.shutdown import register_for_cleanup, unregister_from_cleanup, force_cleanup
