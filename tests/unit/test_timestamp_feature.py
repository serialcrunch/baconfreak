...
class TestTimestampedFilenames:
    ...
    def test_session_timestamp_format(self):
        ...
        assert re.match(timestamp_pattern, scanner.session_timestamp), \
    ...
    def test_timestamped_paths_during_run(self, mock_config, mock_pcap_writers, mock_init_bt):
        ...
        assert scanner.actual_unknown_pcap_path.name == f"Bacon-{session_timestamp}-bfreak-unknown.pcap"
        assert scanner.actual_devices_pcap_path.name == f"Bacon-{session_timestamp}-bfreak-devices.pcap"
