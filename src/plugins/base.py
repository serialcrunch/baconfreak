...
class PluginRegistry:
    ...
    def create_plugin(
        self, protocol: str, config: Dict[str, Any], console: Optional[Console] = None
    ) -> Optional[CapturePlugin]:
        """
    ...
    def list_all_plugins(self) -> Dict[str, PluginInfo]:
        ...
        return {protocol: self.get_plugin_info(protocol) for protocol in self.list_protocols()}
